...
- **完成后**: 写出规范总结，交由管理任务整理到 STANDARDS.md
...
### 总结内容要求
完成代码编写后，两个 Skill 任务需要分别输出以下总结：

**前端任务总结**：
1. 组件设计模式（组件结构、props 定义、事件处理）
2. 状态管理方式（Context 使用、状态定义、更新方式）
3. API 调用模式（axios 配置、请求/响应处理、错误处理）
4. 路由管理（页面切换方式、路由参数）
5. 样式规范（CSS 变量使用、类名命名）
6. 其他最佳实践

**后端任务总结**：
1. API 设计模式（路由结构、请求/响应格式、错误码）
2. 数据库操作（查询方式、参数化、事务）
3. 认证机制（token 生成/验证、中间件）
4. 日志记录（日志格式、存储位置）
5. Redis 使用（缓存模式、键名设计）
6. 其他最佳实践
