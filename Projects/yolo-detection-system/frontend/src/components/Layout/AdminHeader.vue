<template>
  <header class="admin-header glass-navbar">
    <div class="header-left">
      ...
      <div class="logo">
        <span class="logo-text font-logo">YOLO ADMIN</span>
      </div>
    </div>
    <div class="header-right">
      ...
      <el-dropdown trigger="click" class="user-dropdown" @command="handleCommand">
        <div class="user-info">
          ...
          <span v-if="!isMobile" class="username">{{ userStore.userInfo?.username || '管理员' }}</span>
        ...
        <template #dropdown>
          <el-dropdown-menu>
            ...
            <el-dropdown-item command="user_side">
